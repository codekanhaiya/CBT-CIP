...
| 📌 Description         | 🌐 Image                                                |
| ---------------------- | ------------------------------------------------------- |
| Given Task During Internship | ![Task Output](./utilities/Task.png)                    |
| Offer Letter           | ![OfferLetter](./utilities/OfferLetter.jpg)             |
| Completion Certificate | ![Certificate](./utilities/Certificate.jpg)             |
| Recommendation Letter  | ![Recommendation](./utilities/RecommendationLetter.jpg) |
